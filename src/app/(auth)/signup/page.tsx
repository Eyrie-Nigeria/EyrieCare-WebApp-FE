...
import { Mail, ChevronDown, Eye, EyeOff, Check, School } from 'lucide-react';
    ...
    return (
        <div className="flex flex-col gap-8">
            ...
            <form className="flex flex-col gap-5" onSubmit={(e) => e.preventDefault()}>
                ...
                <Button
                    className="mt-2 w-full bg-primary-auth hover:bg-primary-auth-hover text-background-auth-deep font-bold py-3.5 text-base transition-all duration-200 shadow-[0_4px_14px_0_rgba(43,238,121,0.25)] hover:shadow-[0_6px_20px_rgba(43,238,121,0.35)] active:scale-[0.98]"
                >
                    Sign Up
                </Button>
            </form>
