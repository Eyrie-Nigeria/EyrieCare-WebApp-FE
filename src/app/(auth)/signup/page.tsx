...
import { Mail, ChevronDown, Eye, EyeOff, Check } from 'lucide-react';
        ...
        <div className="flex flex-col gap-8">
            ...
            <form className="flex flex-col gap-5" onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="flex flex-col gap-1.5">
                    ...
                    <div className="relative group">
                        <select
                            defaultValue=""
                            className="w-full appearance-none rounded-xl border border-gray-200 dark:border-border-auth-green bg-white dark:bg-surface-auth-dark px-4 py-3.5 text-base text-text-main dark:text-white placeholder-gray-400 dark:placeholder-text-auth-light-green/40 focus:border-primary-auth focus:ring-1 focus:ring-primary-auth transition-colors outline-none cursor-pointer"
                        >
                        ...
                        <ChevronDown className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 dark:text-text-auth-light-green w-6 h-6 pointer-events-none" />
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-1.5">
                    ...
                    <p className="text-xs text-gray-500 dark:text-text-auth-light-green/70 mt-1">
            ...
            <div className="text-center">
                <p className="text-xs text-gray-400 dark:text-text-auth-light-green/50">
                    ...
                    <a className="underline hover:text-gray-600 dark:hover:text-text-auth-light-green/80 mx-1" href="#">Terms</a>
                    and
                    <a className="underline hover:text-gray-600 dark:hover:text-text-auth-light-green/80 mx-1" href="#">Privacy Policy</a>.
                </p>
            </div>
        </div>
    );
