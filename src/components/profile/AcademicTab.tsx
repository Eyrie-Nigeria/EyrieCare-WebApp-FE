        ...
        <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="bg-card-dashboard-light dark:bg-card-dashboard-dark rounded-xl p-6 shadow-sm border border-slate-200 dark:border-transparent transition-all duration-300">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="text-slate-900 dark:text-white text-lg font-bold">Academic Status</h3>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <AcademicField label="Medical School" value="Stanford University School of Medicine" />
                    <AcademicField label="Program" value="M.D. Program" />
                    <AcademicField label="Current Year" value="Year 3 (Clinical Rotations)" />
                ...
                <div className="mt-8 pt-6 border-t border-slate-100 dark:border-card-dashboard-dark/30">
                    <Button variant="outline" className="flex items-center gap-2 font-bold text-xs">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-card-dashboard-light dark:bg-card-dashboard-dark rounded-xl p-6 shadow-sm border border-slate-200 dark:border-transparent transition-all duration-300">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h3 className="text-slate-900 dark:text-white text-lg font-bold">Certifications</h3>
                    </div>

                    <div className="space-y-4">
                        <CertItem title="ACLS Certification" date="Expires June 2025" />
                        <CertItem title="BLS Certification" date="Expires March 2025" />
                        <Button variant="outline" className="w-full border-dashed border-slate-300 dark:border-card-dashboard-dark py-8 flex flex-col items-center gap-2 text-slate-400 hover:text-primary-dashboard hover:border-primary-dashboard hover:bg-primary-dashboard/5 transition-all group">
                            <span className="text-lg group-hover:scale-110 transition-transform">+</span>
                            <span className="text-[11px] font-bold uppercase tracking-wider">Add New Certificate</span>
                        </Button>
                    </div>
                </div>
                ...
                <div className="bg-card-dashboard-light dark:bg-card-dashboard-dark rounded-xl p-6 shadow-sm border border-slate-200 dark:border-transparent transition-all duration-300">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h3 className="text-slate-900 dark:text-white text-lg font-bold">Latest Results</h3>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <Button variant="ghost" className="w-full text-primary-dashboard font-bold hover:bg-primary-dashboard/5 text-xs transition-colors">
        ...
        <div className="flex items-center justify-between p-3.5 rounded-lg bg-slate-50 dark:bg-background-dashboard-dark border border-slate-100 dark:border-card-dashboard-dark/20 group cursor-pointer hover:border-primary-dashboard/30 hover:shadow-md transition-all">
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-[10px] text-text-dashboard-secondary-light font-medium">{date}</p>
                </div>
            </div>
        ...
        <div className="flex items-center justify-between p-3.5 rounded-lg bg-slate-50 dark:bg-background-dashboard-dark border border-slate-100 dark:border-card-dashboard-dark/20 group hover:border-slate-200 dark:hover:border-card-dashboard-dark transition-all">
            ...
            <div className="flex items-center gap-2">
                <div className="w-16 bg-slate-200 dark:bg-white/10 rounded-full h-1.5 hidden sm:block">
                    <div className="bg-primary-dashboard h-1.5 rounded-full" style={{ width: score }}></div>
                </div>
                <span className="text-sm font-bold text-primary-dashboard">{score}</span>
            </div>
        </div>
    );
}
