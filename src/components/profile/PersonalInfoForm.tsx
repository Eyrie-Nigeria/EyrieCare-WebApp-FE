...
import { Mail, Phone, Lock, ChevronRight, PlusCircle, User } from 'lucide-react';
    ...
    return (
        <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="bg-card-dashboard-light dark:bg-card-dashboard-dark rounded-xl p-6 shadow-sm border border-slate-200 dark:border-transparent transition-all duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="flex flex-col gap-1.5">
                        <label className="text-xs font-semibold text-text-dashboard-secondary-light dark:text-text-dashboard-secondary-dark uppercase tracking-wide">First Name</label>
                        <Input
                            type="text"
                            defaultValue="Alex"
                    ...
                    <div className="flex flex-col gap-1.5">
                        <label className="text-xs font-semibold text-text-dashboard-secondary-light dark:text-text-dashboard-secondary-dark uppercase tracking-wide">Last Name</label>
                        <Input
                            type="text"
                            defaultValue="Mercer"
                            leftIcon={<User className="w-5 h-5" />}
                    ...
                    <div className="flex flex-col gap-1.5">
                        <label className="text-xs font-semibold text-text-dashboard-secondary-light dark:text-text-dashboard-secondary-dark uppercase tracking-wide">Email Address</label>
                        <Input
                            type="email"
                    ...
                    <div className="flex flex-col gap-1.5">
                        <label className="text-xs font-semibold text-text-dashboard-secondary-light dark:text-text-dashboard-secondary-dark uppercase tracking-wide">Phone Number</label>
                        <Input
                            type="tel"
            ...
            <div className="bg-card-dashboard-light dark:bg-card-dashboard-dark rounded-xl p-6 shadow-sm border border-slate-200 dark:border-transparent transition-all duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="flex flex-col gap-1.5">
                        <label className="text-xs font-semibold text-text-dashboard-secondary-light dark:text-text-dashboard-secondary-dark uppercase tracking-wide">Student ID</label>
                        ...
                        <p className="text-[10px] text-text-dashboard-secondary-light mt-1 pl-1">Cannot be changed</p>
                    </div>
                    <div className="flex flex-col gap-1.5">
                        <label className="text-xs font-semibold text-text-dashboard-secondary-light dark:text-text-dashboard-secondary-dark uppercase tracking-wide">Expected Graduation</label>
                        <Input
                            type="text"
                    ...
                    <div className="md:col-span-2 p-4 rounded-xl border border-dashed border-primary-dashboard/30 bg-primary-dashboard/5 flex items-center justify-between group cursor-pointer hover:bg-primary-dashboard/10 transition-all duration-200">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="font-bold text-slate-900 dark:text-white text-sm">Add Specialty Interest</p>
                                <p className="text-xs text-text-dashboard-secondary-light dark:text-text-dashboard-secondary-dark">Let mentors know what fields you are interested in</p>
                            </div>
                        </div>
