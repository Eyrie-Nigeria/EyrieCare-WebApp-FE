    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="bg-card-dashboard-light dark:bg-card-dashboard-dark rounded-xl p-6 shadow-sm border border-slate-200 dark:border-transparent transition-all duration-300">
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-xs font-bold text-primary-dashboard bg-primary-dashboard/10 px-2 py-1 rounded-full">
            80%
          </span>
        </div>
        <div className="w-full bg-slate-100 dark:bg-background-dashboard-dark rounded-full h-2 mb-6">
          <div
            className="bg-primary-dashboard h-2 rounded-full shadow-[0_0_8px_rgba(17,212,82,0.4)]"
            style={{ width: "80%" }}
          ></div>
        </div>
      ...
      <div className="bg-card-dashboard-light dark:bg-card-dashboard-dark rounded-xl p-6 shadow-sm border border-slate-200 dark:border-transparent transition-all duration-300">
        <h4 className="font-bold text-slate-900 dark:text-white text-sm mb-5">
          Quick Preferences
        </h4>
        <div className="space-y-5">
          ...
          <PreferenceToggle
            ...
            defaultChecked
          />
          <PreferenceToggle label="Dark Mode" sublabel="System default" />
        </div>
  ...
  return (
    <div className="flex items-center justify-between group">
      <div className="flex flex-col">
        ...
        <span className="text-[11px] text-text-dashboard-secondary-light dark:text-text-dashboard-secondary-dark">
          {sublabel}
        </span>
      </div>
