    ...
    return (
        <section className="w-full">
            <div
                ...
                style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuDN9ez_T7r8Am6QCgGmCDJj6Ghw5EHjMH4ECM-_wcqt0ZcLFCtHyj6v8bhy-VdClN3KVFSgLxiV9ZjtKqFCY-HeaplHiOuk2HLCb2tB6-KEt25BYRChYJBNgnWoOjAu6E8NwVVOIHFwyVK_IH7lNRpF4qeOjIwmHE_jPS7ZuDiDaDZHd_o8oJBwQxuz1tslAv9kFQx6lZ3M3ESECUzRyfY8Bct2Y98sOXuCdY7hQBbub-6_jkbd_eYOJngdXIt_Ww9tCx4NhPOPAdc")' }}
            >
