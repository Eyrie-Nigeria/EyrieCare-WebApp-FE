    ...
    <section className="py-12 bg-surface-light dark:bg-surface-dark border-y border-border-light dark:border-border-dark">
      <div className="layout-container">
        <div className="flex flex-col">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold text-text-main dark:text-white text-center">See how it works</h2>
            <p className="text-gray-500 dark:text-gray-400 mt-2 text-center max-w-3xl">
              A user interface designed for focus, clarity, and efficiency during your busiest rotations.
            </p>
          </motion.div>
          ...
          >
            ...
            >
              <div className="absolute inset-0 bg-linear-to-t from-black/60 to-transparent p-6 flex flex-col justify-end">
                <span className="text-white font-bold text-lg">{galleryItems[0].title}</span>
                <span className="text-gray-200 text-sm">{galleryItems[0].subtitle}</span>
              </div>
            </motion.div>
