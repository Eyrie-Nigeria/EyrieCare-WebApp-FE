    ...
    <section className="relative">
      <div className="layout-container py-12 md:py-20 lg:py-24">
        <div className="flex flex-col gap-10 lg:flex-row lg:items-center lg:gap-16">
          ...
          >
            <motion.div variants={fadeInUp} className="flex flex-col gap-4 text-left">
              <h1 className="text-4xl font-black leading-[1.1] tracking-tight text-text-main dark:text-white md:text-5xl lg:text-7xl">
                Master Your Medical <span className="text-gradient">Education</span>
              </h1>
              <h2 className="text-lg font-normal leading-relaxed text-gray-600 dark:text-gray-300 max-w-2xl">
                Join thousands of medical students using our tools to manage clinical cases, collaborate securely, and ace their exams with confidence.
              </h2>
            </motion.div>
            ...
            {/* Trust Indicators */}
            <motion.div variants={fadeInUp} className="flex items-center gap-2 pt-2 text-sm text-gray-500 dark:text-gray-400">
          ...
          >
            <div className="relative w-full aspect-4/3 rounded-2xl overflow-hidden shadow-2xl bg-surface-dark/5 dark:bg-white/5 ring-1 ring-black/5 dark:ring-white/10 group">
              <div
                ...
                style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuCYoKKx8dyAGkexV9TOMm9l-9M5Q68v3aCN2Ndt9rYEXEf6QOq8C7hjgGquqy6MFsgXTVI-wWQ59-4EVhIKi2EL3FEqqHKLMWn07VH0OkKZCctcqpVyayVYGH4BJWgLJRqnbG9UNvHrzeasPXHVIuh9DSfLDh3zbjpC-UhDssyL8upvBx3I9yLdR_dvZWodYnszcte7S6ilowbxMut9YSPMqwIo9ge2aJFmLPpXWyJuhrr5u03E1lHVCJw-ofgU0yu__ReALaWQxBQ")' }}
              />
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <div className="text-sm font-bold text-text-main dark:text-white">Cardiology Review</div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">Due Today • 15 Questions</div>
                  </div>
                </div>
