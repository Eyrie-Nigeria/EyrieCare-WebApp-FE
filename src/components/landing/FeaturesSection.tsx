...
const features: Feature[] = [
  {
    ...
    description:
      "Track patient interactions, log clinical hours, and manage your SOAP notes securely in one place compliant with education standards.",
  },
  {
    icon: MessageSquare,
    title: "Secure Chat",
    description:
      "Collaborate with peers on complex cases and get mentorship from attending physicians through encrypted, real-time messaging.",
  },
  {
    icon: GraduationCap,
    title: "Practice Tests",
    description:
      "Prepare for your board exams with our adaptive question bank containing thousands of high-yield practice questions.",
  },
];
        ...
        <div className="flex flex-col">
          ...
          >
            ...
            <p className="text-base md:text-lg text-gray-600 dark:text-gray-300 max-w-150">
              Everything you need to succeed in your medical journey, from your
              first year to residency.
            </p>
          </motion.div>
